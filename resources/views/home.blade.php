            ...
            <div class="row no-gutters">
                <div class="col-12">
                    <div class="featured-title">
                        ...
                        <a href="#">{{ trans('text.home.view_all_games') }}</a>
                    </div>
                </div>
            </div>
            <div class="row no-gutters">
                <div class="col-12">
                    <div class="featured-slide">
                        <div class="single-featured img-full">
                            <a href="#"><img src="{{ asset('images/feature/feature-slide-1.jpg') }}" alt=""></a>
                        </div>
                        <div class="single-featured img-full">
                            <a href="#"><img src="{{ asset('images/feature/feature-slide-2.jpg') }}" alt=""></a>
                        </div>
                        <div class="single-featured img-full">
                            <a href="#"><img src="{{ asset('images/feature/feature-slide-3.jpg') }}" alt=""></a>
                        </div>
                        <div class="single-featured img-full">
                            <a href="#"><img src="{{ asset('images/feature/feature-slide-4.jpg') }}" alt=""></a>
                        </div>
                        <div class="single-featured img-full">
                            <a href="#"><img src="{{ asset('images/feature/feature-slide-5.jpg') }}" alt=""></a>
                        </div>
                        <div class="single-featured img-full">
                            <a href="#"><img src="{{ asset('images/feature/feature-slide-6.jpg') }}" alt=""></a>
                        </div>
                        <div class="single-featured img-full">
                            <a href="#"><img src="{{ asset('images/feature/feature-slide-4.jpg') }}" alt=""></a>
                        </div>
            ...
            <div class="row game-slide">
                <div class="col-4">
                    <div class="single-game mb-50">
                        <div class="game-img">
                            <a href="games-details.html"><img src="{{ asset('images/game/game1.jpg') }}" alt=""></a>
                        </div>
                    ...
                    <div class="single-game mb-50">
                        <div class="game-img">
                            <a href="games-details.html"><img src="{{ asset('images/game/game4.jpg') }}" alt=""></a>
                        </div>
                        <div class="game-content">
                            <h4><a href="games-details.html">the elder scroll</a></h4>
                            <span>pc/xbox/ps4</span>
                ...
                <div class="col-4">
                    <div class="single-game mb-50">
                        <div class="game-img">
                            <a href="games-details.html"><img src="{{ asset('images/game/game2.jpg') }}" alt=""></a>
                        </div>
                        <div class="game-content">
                            <h4><a href="games-details.html">the elder scroll</a></h4>
                            <span>pc/xbox/ps4</span>
                    ...
                    <div class="single-game mb-50">
                        <div class="game-img">
                            <a href="games-details.html"><img src="{{ asset('images/game/game5.jpg') }}" alt=""></a>
                        </div>
                        <div class="game-content">
                            <h4><a href="games-details.html">the elder scroll</a></h4>
                            <span>pc/xbox/ps4</span>
                ...
                <div class="col-4">
                    <div class="single-game mb-50">
                        <div class="game-img">
                            <a href="games-details.html"><img src="{{ asset('images/game/game3.jpg') }}" alt=""></a>
                        </div>
                        <div class="game-content">
                            <h4><a href="games-details.html">the elder scroll</a></h4>
                            <span>pc/xbox/ps4</span>
                    ...
                    <div class="single-game mb-50">
                        <div class="game-img">
                            <a href="games-details.html"><img src="{{ asset('images/game/game6.jpg') }}" alt=""></a>
                        </div>
                        <div class="game-content">
                            <h4><a href="games-details.html">the elder scroll</a></h4>
                            <span>pc/xbox/ps4</span>
