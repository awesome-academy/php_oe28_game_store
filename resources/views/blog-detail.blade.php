                                ...
                                @if (count($post->comments) == 0)
                                    <div class="leave-comment m-b-30">
                                        <p class="p-b-25">
                                            <i>
                                                <i class="fa fa-comments-o" aria-hidden="true"></i>
                                                <span class="p-b-25">{{ trans('text.blog-detail.no_comment') }}
                                                    <label for="comment">
                                                        {{ trans('text.blog-detail.the_first') }} <i class="fa fa-hand-o-down" aria-hidden="true"></i>
                                                    </label>
                                                </span>
                                            </i>
                                        </p>
                                    ...
                                    <div class="comments m-b-30">
                                        @foreach ($post->comments as $item)
                                            <p class="comment-detail" data-id="{{ $item->id }}">
                                                <i>
                                                    <b>
                                                        <i class="fa fa-user-circle" aria-hidden="true"></i> {{ $item->account->email }}
                                                    </b>
                                                    @if ($post->account_id == $item->account->id) <span class="badge badge-success">{{ trans('text.blog-detail.author') }}</span> @endif - {{ $item->updated_at }}
                                                ...
                                                <p class="comment-text p-b-25" data-id="{{ $item->id }}">
                                                    {{ $item->comment }}
                                                </p>
                                            </p>
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <textarea class="dis-block s-text7 size18 bo12 p-l-18 p-r-18 p-t-13 m-b-20" id="ta-update-comment" data-id="{{ $item->id }}" name="update_comment"
                                                                placeholder="{{ trans('text.blog-detail.comment_ph') }}">
                                                                {{ $item->comment }}
                                                            </textarea>
                                                        </div>
...
@section('js')
    <script type="text/javascript" src="{{ asset('/bower_components/client/js/blog-detail.js') }}"></script>
@endsection
