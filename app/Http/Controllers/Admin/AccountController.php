...
class AccountController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return trans('text.admin.account.update_success');
        } catch (ModelNotFoundException $e) {
            return trans('text.admin.account.update_fail');
        }
    }
    ...
    public function destroy($id)
    {
        try {
            ...
            return trans('text.admin.account.delete_success');
        } catch (ModelNotFoundException $e) {
            return trans('text.admin.account.delete_fail');
        }
    }
}
